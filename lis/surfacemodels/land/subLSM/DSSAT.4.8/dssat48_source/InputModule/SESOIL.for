...
C=======================================================================
      ...
      SUBROUTINE SESOIL(nest,FILES,FILEX,FILEX_P,NSENS,RNMODE,SLNF,SLPF,
     &     U,SWCON,CN2,SALB,DEPMAX,PEDON,SLNO,SLTX,LL,DUL,SAT,WR,BD,OC,
     &     PH,DLAYR,NLAYR,DS,LNIC,LNSA,YRIC,PRCROP,WRESR,WRESND,EFINOC,
