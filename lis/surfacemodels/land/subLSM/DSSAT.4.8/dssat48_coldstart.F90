...
!BOP
!
! !ROUTINE: dssat48_coldstart
! \label{dssat48_coldstart}
!
! !REVISION HISTORY:
...
!
!  21 Jun 2023: Pang-Wei Liu; Added DSSAT48 coldstart routine
!
! !INTERFACE:
subroutine dssat48_coldstart(mtype)
...
! !DESCRIPTION:
!
!  This routine initializes the DSSAT state variables with some
...
!EOP
    ...
    do n=1, LIS_rc%nnest
       if( trim(LIS_rc%startcode) .eq. "coldstart" ) then
          ...
          write(LIS_logunit,*) "[INFO] DSSAT_coldstart -- coldstart DSSAT states"
...
end subroutine dssat48_coldstart
