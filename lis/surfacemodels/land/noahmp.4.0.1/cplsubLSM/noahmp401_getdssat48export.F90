...
!BOP
! !ROUTINE: noahmp401_getdssat48export
! \label{noahmp401_getdssat48export}
!
! !REVISION HISTORY:
! 26 Jun 2023: Pang-Wei Liu
!
! !INTERFACE:
subroutine noahmp401_getdssat48export(n, LSM2SUBLSM_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
end subroutine noahmp401_getdssat48export
