...
!BOP
! !ROUTINE: noahmp401_setdssat48import
! \label{noahmp401_setdssat48import}
!
! !REVISION HISTORY:
! 26 Jun 2023: Pang-Wei Liu
!
! !INTERFACE:
subroutine noahmp401_setdssat48import(n, SubLSM2LSM_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
end subroutine noahmp401_setdssat48import
